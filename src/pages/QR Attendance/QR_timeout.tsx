...
const QRAttendance_Timeout = () => {
    ...
    const [attendanceType, setAttendanceType] = useState('time_out');
    ...
    const logAttendance = (studentLRN: string, attendanceType: string) => {
        ...
        axios.post('https://studentportal.lcsinhs.com/scripts/qr-attendance-timeout.php', new URLSearchParams(attendanceData).toString(), {
            headers: {
            ...
            .then((response) => {
                if (response.data && response.data.success) {
                    showToast("Attendance Time Out Recorded.", "success");
                    ...
                    console.error("Failed to log attendance. Invalid server response:", response.data);
                ...
                <IonContent>
                        ...
                        <IonToolbar color="dark">
                            ...
                            <div className="attend-header">
                                ...
                                <IonButton
                                    color={"tertiary"}
                                    onClick={() => {
                                        history.push('/qr-attendance-timein')
                                    }}
                                > Switch to Time In
                                </IonButton>
                    ...
                    <div className="attend-body">
                        ...
                        <div>
                            ...
                            <div className="center">
                                <h1>Attendance QR Scanner - Time Out</h1>
                            </div>
